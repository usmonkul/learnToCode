...
import { runChallenge } from '@/lib/pyRunner'
...
export default function PyPlayground({ challenge, topicId, slug, nextChallenge }) {
    ...
    <div className="not-prose my-6 overflow-hidden rounded-3xl bg-neutral-900">
      <div className="flex items-center justify-between px-5 py-3.5">
        <span className="flex items-center gap-2 text-xs font-medium uppercase tracking-[.12em] text-neutral-400">
          <span className="flex h-5 w-5 items-center justify-center rounded bg-blue-400 text-[10px] font-bold text-neutral-900">
            PY
          </span>
          Python
        </span>
          ...
          <div className="flex items-center gap-3">
            <div className="flex gap-2">
              ...
              >
                ...
                {status === 'running' ? 'Yuklanmoqda...' : 'Yuritish'}
              </button>
              <button
                type="button"
